...
export const Button = forwardRefWithAs<"button", ButtonProps>(
  (
    ...
    return (
      ...
      >
        {startDecorator && (
          <span className="btn-icon mr-2">{startDecorator}</span>
        )}
        {children}
